 ...
 * @extends ModalDialog
 */
class DebugDialog extends ModalDialog {
  ...
  constructor(player, options) {
    ...
    this.updateDisplay = Fn.bind_(this, this.updateDisplay);
  ...
  buildCSSClass() {
    return super.buildCSSClass() + 'vjs-debug';
    // vjs-text-track-settings vjs-debug-settings
  }
...
Component.registerComponent('DebugDialog', DebugDialog);
