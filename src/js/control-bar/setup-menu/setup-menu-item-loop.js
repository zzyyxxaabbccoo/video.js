 ...
 * @extends MenuItem
 */
class SetupMenuItemLoop extends MenuItem {
  ...
  constructor(player, options) {
    ...
    // const label_en = options.content;
    ...
    this.on(player, 'loop2change', this.update);
  }
  ...
  createEl(type, props, attrs) {
    ...
    return super.createEl('li', Object.assign({
      className: 'vjs-menu-item',
   ...
   */
  handleClick(event) {
    if (this.player().loop2() === true) {
      this.player().loop2(false);
      // this.removeClass('selectorOn');
      // this.addClass('selectorOff');
    } else {
      this.player().loop2(true);
  ...
  update(event) {
    ...
    // this.player().log(this.el_);
    // this.player().log('loop:'+this.player().loop());
  }
}
 ...
 * @private
 */
SetupMenuItemLoop.prototype.contentElType = 'button';

Component.registerComponent('SetupMenuItemLoop', SetupMenuItemLoop);
export default SetupMenuItemLoop;
